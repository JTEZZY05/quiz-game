...
def quiz_run(questions_answers):
    ...
    for questions, answers in questions_answers.items():
        ...
        #Case to ensure that user input is correctly capitalized on questions 5 and 6(First letter only)
        if current_question == 5 or current_question == 6 or current_question == 7 or current_question == 8:
            user_input = user_input.capitalize()
        #Case to ensure that user input is correctly capitalized on question 9(First letters of both words)
        if current_question == 9:
            user_input = user_input.title()
        if user_input == answers and current_question < 9: # Loops up untill 8, this is because 9 and 10 have special responses
        ...
        elif user_input == answers and current_question == 9:
            print("✨🔥🚀HOW DO YOU EVEN KNOW THAT?✨🔥🚀") #I am gonna be impressed if someone just knows this
            score+=1
        elif user_input == answers and current_question ==10:
